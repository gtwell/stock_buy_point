...
jigou_2020Q4 = ['贵州茅台', '五粮液', '宁德时代', '美的集团', '比亚迪', '海天味业', '海康威视', '中国中免', '恒瑞医药', '迈瑞医疗',
                ...
                '紫光国微', '亿联网络', '金域医学', '凯莱英', '三环集团', '今世缘', '高德红外', '欧普康视', '苏泊尔', '长电科技',
...
ZiXuan = ['美亚光电', '大华股份', '中信建投', '上海新阳', '苏州固锝', '老板电器', '上海贝岭', '伟明环保', '中国太保', '珠江啤酒', 
          '上峰水泥', '德赛西威', '捷捷微电', '通富微电', '三只松鼠', '良品铺子', '中国长城', '南大光电', '得润电子', '安洁科技',
          '晶盛机电', '燕京啤酒', '江西铜业', '均胜电子', '中材科技', '中航重机', '德邦股份', '春秋航空', '桃李面包', '中直股份',
          '航发控制', '光明乳业', '中国人寿', '联美控股', '伟星新材', '长盈精密', '海格通信', '中宠股份', '福成股份', '超图软件',
          '士兰微', '中科软', '新洋丰', '福莱特', '科沃斯', '白云山', '利亚德', '张裕A', '金达威', '中联重科', '星源材质', '中国汽研',
          '鼎龙股份', '华灿光电', '招商积余']

Champion = ['贝瑞基因', '迪安诊断', '密尔克卫', '富邦股份', '金城医药', '广州酒家', '博实股份', '巨星科技', '安车检测',
